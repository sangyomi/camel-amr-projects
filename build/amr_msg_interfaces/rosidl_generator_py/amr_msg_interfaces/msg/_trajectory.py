...
class Metaclass_Trajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('amr_msg_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'amr_msg_interfaces.msg.Trajectory')
            logger.debug(
...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    def __init__(self, **kwargs):
        ...
        self.stack_size = kwargs.get('stack_size', int())
    ...
    def stack_size(self, value):
        if __debug__:
            assert \
                ...
                "The 'stack_size' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'stack_size' field must be an integer in [-2147483648, 2147483647]"
