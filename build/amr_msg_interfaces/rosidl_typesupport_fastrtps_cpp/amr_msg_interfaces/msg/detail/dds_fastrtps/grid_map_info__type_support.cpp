...
#include "amr_msg_interfaces/msg/detail/grid_map_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const amr_msg_interfaces::msg::GridMapInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  amr_msg_interfaces::msg::GridMapInfo & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const amr_msg_interfaces::msg::GridMapInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<amr_msg_interfaces::msg::GridMapInfo *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_amr_msg_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<amr_msg_interfaces::msg::GridMapInfo>()
{
  return &amr_msg_interfaces::msg::typesupport_fastrtps_cpp::_GridMapInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, amr_msg_interfaces, msg, GridMapInfo)() {
  return &amr_msg_interfaces::msg::typesupport_fastrtps_cpp::_GridMapInfo__handle;
}
