...
#include "amr_msg_interfaces/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const amr_msg_interfaces::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<amr_msg_interfaces::msg::Trajectory *>(
    untyped_ros_message);
...
{
  return &amr_msg_interfaces::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
