...
#include "amr_msg_interfaces/msg/detail/grid_map_info__rosidl_typesupport_fastrtps_c.h"
...
using _GridMapInfo__ros_msg_type = amr_msg_interfaces__msg__GridMapInfo;
...
size_t get_serialized_size_amr_msg_interfaces__msg__GridMapInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GridMapInfo__ros_msg_type * ros_message = static_cast<const _GridMapInfo__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GridMapInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_amr_msg_interfaces__msg__GridMapInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_msg_interfaces
size_t max_serialized_size_amr_msg_interfaces__msg__GridMapInfo(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_amr_msg_interfaces__msg__GridMapInfo(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, amr_msg_interfaces, msg, GridMapInfo)() {
