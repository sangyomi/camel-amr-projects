...
#include "amr_msg_interfaces/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "amr_msg_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_amr_msg_interfaces
...
using _Trajectory__ros_msg_type = amr_msg_interfaces__msg__Trajectory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: stack_size
  {
    cdr << ros_message->stack_size;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_msg_interfaces
size_t get_serialized_size_amr_msg_interfaces__msg__Trajectory(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory__ros_msg_type * ros_message = static_cast<const _Trajectory__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name stack_size
  {
    size_t item_size = sizeof(ros_message->stack_size);
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_amr_msg_interfaces__msg__Trajectory(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_msg_interfaces
size_t max_serialized_size_amr_msg_interfaces__msg__Trajectory(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_amr_msg_interfaces__msg__Trajectory(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_Trajectory = {
  "amr_msg_interfaces::msg",
  "Trajectory",
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, amr_msg_interfaces, msg, Trajectory)() {
