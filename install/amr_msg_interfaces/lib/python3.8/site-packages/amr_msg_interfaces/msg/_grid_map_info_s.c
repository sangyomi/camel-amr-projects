...
bool amr_msg_interfaces__msg__grid_map_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amr_msg_interfaces.msg._grid_map_info.GridMapInfo", full_classname_dest, 49) == 0);
  }
  amr_msg_interfaces__msg__GridMapInfo * ros_message = _ros_message;
  {  // header
...
PyObject * amr_msg_interfaces__msg__grid_map_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("amr_msg_interfaces.msg._grid_map_info");
